...
class ImageClassify:
    ...
    def displayimage():
        ...
        canvas.get_tk_widget().place(relx=0.5, rely=0.61, anchor="center")
        canvas._tkcanvas.place(relx=0.5, rely=0.61, anchor="center")
...
filepathdisplay.place(relx=0.5, rely=0.32, anchor="center")
